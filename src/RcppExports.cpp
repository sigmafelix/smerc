...
// roll_psum
arma::vec roll_psum(arma::vec& X, double p);
RcppExport SEXP _smerc_roll_psum(SEXP XSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type X(XSEXP);
    Rcpp::traits::input_parameter< double >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(roll_psum(X, p));
    return rcpp_result_gen;
END_RCPP
}
// roll_var
arma::vec roll_var(arma::vec& X);
RcppExport SEXP _smerc_roll_var(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type X(XSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_smerc_roll_psum", (DL_FUNC) &_smerc_roll_psum, 2},
    {"_smerc_roll_var", (DL_FUNC) &_smerc_roll_var, 1},
