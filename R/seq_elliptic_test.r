...
#' @author Joshua French, Insang Song
#' @export
#' @keywords internal
seq_elliptic_test = function(coords, cases, pop,
  ...
  nn = elliptic.nn(d, pop, max(ubpop_seq), shape = shape, nangle = nangle)
